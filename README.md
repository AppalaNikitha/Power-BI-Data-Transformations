This project focuses on cleaning and transforming a bank transaction dataset using **Power Query in Power BI** to prepare it for accurate reporting. 
I performed key data-cleaning steps such as fixing inconsistent data types, expanding the date field into year/month/day components, 
